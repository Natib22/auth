  ...
  return (
    <>
      ...
      <div className="flex gap-4">
        ...
        <div className="flex flex-col gap-1">
          ...
          <p className="font-semibold">
            {job.datePosted ? job.datePosted.slice(0, 10) : ""}
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-col gap-6">
        <h1 className="text-2xl font-black leading-[28.8px] text-left">
          Catagories
        </h1>
        <div className="flex gap-2 flex-wrap">
          {job.categories.map((category, index) =>
            index % 2 == 0 ? (
              <p
                key={index}
                className="flex items-center justify-center bg-[#56CDAD1A] text-xs text-[#56CDAD] rounded-2xl h-[31px] text-nowrap w-auto  py-1 px-3"
              >
                {category}
              </p>
            ) : (
              <p
                key={index}
                className="flex items-center justify-center bg-[#EB85331A] text-xs text-[#FFB836] rounded-2xl h-[31px] text-nowrap w-auto  py-1 px-3"
              >
                {category}
              </p>
            )
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="flex gap-2 flex-wrap">
          {job.requiredSkills.map((skill, i) => (
            <p
              key={i}
              className="flex items-center justtify-center font-epilogue text-base bg-[#F8F8FD]  text-[#4640DE]  h-[37px] min-w-20 w-auto  py-1 px-3"
            >
              {skill}
            </p>
          ))}
...
export default RightJobDescription;
