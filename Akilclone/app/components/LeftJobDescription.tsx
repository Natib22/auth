...
const LeftJobDescription: React.FC<{ job: JobData }> = ({ job }) => {
  if (!job) {
    return <p>loading</p>;
  }
  ...
  return (
    <>
      <div className="flex flex-col gap-4 w-full min-h-[175px] h-auto">
        ...
        <p className="text-base leading-[25.6px] text-left font-normal">
          {job.description}
        </p>
      </div>
        ...
        <ul className="space-y-2">
          {responsibilities.map((responsibility, index) => (
            <li key={index} className="flex ">
              ...
              />
              <p className="ml-2 text-base leading-[25.6px] text-left font-normal">
                {responsibility}
              </p>
            </li>
          ))}
      ...
      <div className="flex flex-col gap-4 w-full  h-auto mt-3">
        ...
        <ul className="list-disc pl-5">
          <li className="">
            <p className="text-base leading-[25.6px] text-left font-normal">
              <span className="text-base leading-[25.6px] text-left font-semibold">
                {" "}
              </span>
              {job.idealCandidate}
            </p>
